...
export default function DateTimePicker({
  ...
  const [draftMinute, setDraftMinute] = useState((dateValue || new Date()).getMinutes());
  const [draftAmPm, setDraftAmPm] = useState((dateValue || new Date()).getHours() >= 12 ? 'PM' : 'AM');
  ...
  return (
    <div className={styles.wrap} ref={wrapRef}>
      ...
      >
        <span className={dateValue ? styles.triggerValue : styles.triggerPlaceholder}>
